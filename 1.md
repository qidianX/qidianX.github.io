...
<head>
	...
	<title>Python While 循环语句 | 菜鸟教程</title>

  <meta name='robots' content='max-image-preview:large' />
<link rel="canonical" href="http://www.runoob.com/python/python-while-loop.html" />
<meta name="keywords" content="Python While 循环语句">
<meta name="description" content="Python While 循环语句 Python 编程中 while 语句用于循环执行程序，即在某条件下，循环执行某段程序，以处理需要重复处理的相同任务。其基本形式为：  while 判断条件(condition)：     执行语句(statements)……  执行语句可以是单个语句或语句块。判断条件可以是任何表达式，任何非零、或非空（null）的值均为true。  当判断条件假 false 时，循环结束。 执行流程图如下：  Gi..">
		
	<link rel="shortcut icon" href="https://static.jyshare.com/images/favicon.ico">
	<link rel="stylesheet" href="/wp-content/themes/runoob/style.css?v=1.182" type="text/css" media="all" />
...
<br><h2 class="left"><span class="left_h2">Python</span> 高级教程</h2>			<a target="_top" data-p="par" title="Python 面向对象"  href="/python/python-object.html" >
	...
	<div class="article">
		...
		<div class="previous-next-links">
			<div class="previous-design-link"><i style="font-size:16px;" class="fa fa-arrow-left" aria-hidden="true"></i> <a href="http://www.runoob.com/python/python-if-statement.html" rel="prev"> Python 条件语句</a> </div>
			<div class="next-design-link"><a href="http://www.runoob.com/python/python-for-loop.html" rel="next"> Python for 循环语句</a> <i style="font-size:16px;" class="fa fa-arrow-right" aria-hidden="true"></i></div>
		</div>
...
<script>
     (adsbygoogle = window.adsbygoogle || []).push({});
		...
		<div class="article-body">
			...
			<h1>Python <span class="color_h1">While 循环语句</span></h1>
<p>Python 编程中 while 语句用于循环执行程序，即在某条件下，循环执行某段程序，以处理需要重复处理的相同任务。其基本形式为：</p>
<pre>
while 判断条件(condition)：
    执行语句(statements)&hellip;&hellip;
</pre>
<p>执行语句可以是单个语句或语句块。判断条件可以是任何表达式，任何非零、或非空（null）的值均为true。</p>

<p>当判断条件假 false 时，循环结束。</p>
<p>执行流程图如下：</p>
<p><img decoding="async" src="https://www.runoob.com/wp-content/uploads/2013/11/886A6E10-58F1-4A9B-8640-02DBEFF0EF9A.jpg" /></p>
<h3>Gif 演示 Python while 语句执行过程</h3>
<p><img decoding="async" src="//www.runoob.com/wp-content/uploads/2014/05/006faQNTgw1f5wnm06h3ug30ci08cake.gif"></p>
<p>复杂一点:</p><p>
<img decoding="async" src="https://www.runoob.com/wp-content/uploads/2013/11/loop-over-python-list-animation.gif"></p>
...
</span><span class="hl-identifier">while</span><span class="hl-code"> </span><span class="hl-brackets">(</span><span class="hl-identifier">count</span><span class="hl-code"> &lt; </span><span class="hl-number">9</span><span class="hl-brackets">)</span><span class="hl-code">:
   </span><span class="hl-reserved">print</span><span class="hl-code"> </span><span class="hl-quotes">'</span><span class="hl-string">The count is:</span><span class="hl-quotes">'</span><span class="hl-code">, </span><span class="hl-identifier">count</span><span class="hl-code">
   </span><span class="hl-identifier">count</span><span class="hl-code"> = </span><span class="hl-identifier">count</span><span class="hl-code"> + </span><span class="hl-number">1</span><span class="hl-code">
 
</span><span class="hl-reserved">print</span><span class="hl-code"> </span><span class="hl-quotes">&quot;</span><span class="hl-string">Good bye!</span><span class="hl-quotes">&quot;</span></div>
</div><br><a href="/try/runcode.php?filename=test_while&type=python" target="_blank"  class="tryitbtn" rel="noopener noreferrer">运行实例 »</a>  </div>
...
<p>
while 语句时还有另外两个重要的命令 continue，break 来跳过循环，continue 用于跳过该次循环，break 则是用于退出循环，此外"判断条件"还可以是个常值，表示循环必定成立，具体用法如下：</p>
<div class="example">
<div class="example_code">
<div class="hl-main"><span class="hl-comment"># continue 和 break 用法</span><span class="hl-code">
 
</span><span class="hl-identifier">i</span><span class="hl-code"> = </span><span class="hl-number">1</span><span class="hl-code">
</span><span class="hl-reserved">while</span><span class="hl-code"> </span><span class="hl-identifier">i</span><span class="hl-code"> &lt; </span><span class="hl-number">10</span><span class="hl-code">:   
    </span><span class="hl-identifier">i</span><span class="hl-code"> += </span><span class="hl-number">1</span><span class="hl-code">
    </span><span class="hl-reserved">if</span><span class="hl-code"> </span><span class="hl-identifier">i</span><span class="hl-code">%</span><span class="hl-number">2</span><span class="hl-code"> &gt; </span><span class="hl-number">0</span><span class="hl-code">:     </span><span class="hl-comment"># 非双数时跳过输出</span><span class="hl-code">
        </span><span class="hl-reserved">continue</span><span class="hl-code">
    </span><span class="hl-reserved">print</span><span class="hl-code"> </span><span class="hl-identifier">i</span><span class="hl-code">         </span><span class="hl-comment"># 输出双数2、4、6、8、10</span><span class="hl-code">
 
</span><span class="hl-identifier">i</span><span class="hl-code"> = </span><span class="hl-number">1</span><span class="hl-code">
</span><span class="hl-reserved">while</span><span class="hl-code"> </span><span class="hl-number">1</span><span class="hl-code">:            </span><span class="hl-comment"># 循环条件为1必定成立</span><span class="hl-code">
    </span><span class="hl-reserved">print</span><span class="hl-code"> </span><span class="hl-identifier">i</span><span class="hl-code">         </span><span class="hl-comment"># 输出1~10</span><span class="hl-code">
    </span><span class="hl-identifier">i</span><span class="hl-code"> += </span><span class="hl-number">1</span><span class="hl-code">
    </span><span class="hl-reserved">if</span><span class="hl-code"> </span><span class="hl-identifier">i</span><span class="hl-code"> &gt; </span><span class="hl-number">10</span><span class="hl-code">:     </span><span class="hl-comment"># 当i大于10时跳出循环</span><span class="hl-code">
        </span><span class="hl-reserved">break</span></div>
</div></div>
<br><hr><h2>无限循环</h2>
<p>
...
</span><span class="hl-identifier">var</span><span class="hl-code"> = </span><span class="hl-number">1</span><span class="hl-code">
</span><span class="hl-reserved">while</span><span class="hl-code"> </span><span class="hl-identifier">var</span><span class="hl-code"> == </span><span class="hl-number">1</span><span class="hl-code"> :  </span><span class="hl-comment"># 该条件永远为true，循环将无限执行下去</span><span class="hl-code">
   </span><span class="hl-identifier">num</span><span class="hl-code"> = </span><span class="hl-builtin">raw_input</span><span class="hl-brackets">(</span><span class="hl-quotes">&quot;</span><span class="hl-string">Enter a number  :</span><span class="hl-quotes">&quot;</span><span class="hl-brackets">)</span><span class="hl-code">
   </span><span class="hl-reserved">print</span><span class="hl-code"> </span><span class="hl-quotes">&quot;</span><span class="hl-string">You entered: </span><span class="hl-quotes">&quot;</span><span class="hl-code">, </span><span class="hl-identifier">num</span><span class="hl-code">
...
<br><hr><h2>循环使用 else 语句</h2>
<p>
在 python 中，while … else 在循环条件为 false 时执行 else 语句块：</p>
<div class="example">
<h2 class="example">实例</h2>
<div class="example_code">
<div class="hl-main"><span class="hl-comment">#!/usr/bin/python</span><span class="hl-code">
   ...
   </span><span class="hl-reserved">print</span><span class="hl-code"> </span><span class="hl-identifier">count</span><span class="hl-code">, </span><span class="hl-quotes">&quot;</span><span class="hl-string"> is  less than 5</span><span class="hl-quotes">&quot;</span><span class="hl-code">
   </span><span class="hl-identifier">count</span><span class="hl-code"> = </span><span class="hl-identifier">count</span><span class="hl-code"> + </span><span class="hl-number">1</span><span class="hl-code">
</span><span class="hl-reserved">else</span><span class="hl-code">:
   </span><span class="hl-reserved">print</span><span class="hl-code"> </span><span class="hl-identifier">count</span><span class="hl-code">, </span><span class="hl-quotes">&quot;</span><span class="hl-string"> is not less than 5</span><span class="hl-quotes">&quot;</span></div>
</div></div>
<p>以上实例输出结果为：</p>
<pre>
0 is less than 5
...
<br><hr><h2>简单语句组</h2>
<p>类似 if 语句的语法，如果你的 while 循环体中只有一条语句，你可以将该语句与while写在同一行中，
如下所示：</p>
<div class="example">
<h2 class="example">实例</h2>
<div class="example_code">
...
</span><span class="hl-identifier">flag</span><span class="hl-code"> = </span><span class="hl-number">1</span><span class="hl-code">
 
</span><span class="hl-identifier">while</span><span class="hl-code"> </span><span class="hl-brackets">(</span><span class="hl-identifier">flag</span><span class="hl-brackets">)</span><span class="hl-code">: </span><span class="hl-reserved">print</span><span class="hl-code"> </span><span class="hl-quotes">'</span><span class="hl-string">Given flag is really true!</span><span class="hl-quotes">'</span><span class="hl-code">
 
</span><span class="hl-reserved">print</span><span class="hl-code"> </span><span class="hl-quotes">&quot;</span><span class="hl-string">Good bye!</span><span class="hl-quotes">&quot;</span></div>
</div></div>
<p><strong>注意：</strong>以上的无限循环你可以使用  <span class="marked">CTRL+C</span> 来中断循环。</p>			<!-- 其他扩展 -->
...
<div class="title" id="comments">
    ...
    <span class="mw-headline" id="qa_headline">6  篇笔记</span>
...
<div id="postcomments"  style="display:none;" >
	<ol class="commentlist">
		<li class="comment even thread-even depth-1" id="comment-11157"><span class="comt-f">#0</span><div class="comt-avatar wrapper"><i style="font-size:36px;" class="fa fa-user-circle" aria-hidden="true"></i><div class="tooltip"><p><i class="fa fa-user" aria-hidden="true"></i>&nbsp;&nbsp;&nbsp;我是可爱男生睡便天下男人</p><p><i class="fa fa-envelope" aria-hidden="true"></i>&nbsp;&nbsp;col***iansy@Outlook.com</p></div><div id="runoobvote-id-11157" data-commid = "11157" class="upvotejs"><a class="upvote"></a> <span class="count">121</span></div></div><div class="comt-main" id="div-comment-11157"><p>猜大小的游戏</p>
<pre>
#!/usr/bin/python
# -*- coding: UTF-8 -*-
...
while m != s:
    ...
    if m == s:
        print('OK')
        break;
</pre><div class="comt-meta wrapper"><span class="comt-author"><a target="_blank" href="javascript:;">我是可爱男生睡便天下男人</a><div class="tooltip tooltip1"><p><i class="fa fa-user" aria-hidden="true"></i>&nbsp;&nbsp;&nbsp;我是可爱男生睡便天下男人</p><p><i class="fa fa-envelope" aria-hidden="true"></i>&nbsp;&nbsp;col***iansy@Outlook.com</p></div></span>8年前 (2017-04-18)</div></div></li><!-- #comment-## -->
<li class="comment odd alt thread-odd thread-alt depth-1" id="comment-11470"><span class="comt-f">#0</span><div class="comt-avatar wrapper"><i style="font-size:36px;" class="fa fa-user-circle" aria-hidden="true"></i><div class="tooltip"><p><i class="fa fa-user" aria-hidden="true"></i>&nbsp;&nbsp;&nbsp;六月耶</p><p><i class="fa fa-envelope" aria-hidden="true"></i>&nbsp;&nbsp;438***@qq.com</p></div><div id="runoobvote-id-11470" data-commid = "11470" class="upvotejs"><a class="upvote"></a> <span class="count">75</span></div></div><div class="comt-main" id="div-comment-11470"><p>猜拳小游戏</p><pre>
#!/usr/bin/python
# -*- coding: UTF-8 -*-
...
</pre><div class="comt-meta wrapper"><span class="comt-author"><a target="_blank" href="javascript:;">六月耶</a><div class="tooltip tooltip1"><p><i class="fa fa-user" aria-hidden="true"></i>&nbsp;&nbsp;&nbsp;六月耶</p><p><i class="fa fa-envelope" aria-hidden="true"></i>&nbsp;&nbsp;438***@qq.com</p></div></span>8年前 (2017-04-27)</div></div></li><!-- #comment-## -->
<li class="comment even thread-even depth-1" id="comment-11625"><span class="comt-f">#0</span><div class="comt-avatar wrapper"><i style="font-size:36px;" class="fa fa-user-circle" aria-hidden="true"></i><div class="tooltip"><p><i class="fa fa-user" aria-hidden="true"></i>&nbsp;&nbsp;&nbsp;夕阳晨伤</p><p><i class="fa fa-envelope" aria-hidden="true"></i>&nbsp;&nbsp;112***5110@qq.com</p></div><div id="runoobvote-id-11625" data-commid = "11625" class="upvotejs"><a class="upvote"></a> <span class="count">35</span></div></div><div class="comt-main" id="div-comment-11625"><p>摇筛子游戏</p><pre>#!/usr/bin/env python3
# -*- coding: utf-8 -*-
...
while True:
    ...
    if count &lt;= 11:
        ...
        time.sleep( 1 )   # 睡眠一秒
    result = []
</pre><div class="comt-meta wrapper"><span class="comt-author"><a target="_blank" href="javascript:;">夕阳晨伤</a><div class="tooltip tooltip1"><p><i class="fa fa-user" aria-hidden="true"></i>&nbsp;&nbsp;&nbsp;夕阳晨伤</p><p><i class="fa fa-envelope" aria-hidden="true"></i>&nbsp;&nbsp;112***5110@qq.com</p></div></span>7年前 (2017-05-03)</div></div></li><!-- #comment-## -->
<li class="comment odd alt thread-odd thread-alt depth-1" id="comment-15354"><span class="comt-f">#0</span><div class="comt-avatar wrapper"><i style="font-size:36px;" class="fa fa-user-circle" aria-hidden="true"></i><div class="tooltip"><p><i class="fa fa-user" aria-hidden="true"></i>&nbsp;&nbsp;&nbsp;(+__+)</p><p><i class="fa fa-envelope" aria-hidden="true"></i>&nbsp;&nbsp;lk0***21428@126.com</p></div><div id="runoobvote-id-15354" data-commid = "15354" class="upvotejs"><a class="upvote"></a> <span class="count">17</span></div></div><div class="comt-main" id="div-comment-15354"><p>十进制转二进制</p><pre>#!/usr/bin/python
# -*- coding: UTF-8 -*-
...
while len(binnum)&gt;0:
    import sys
    sys.stdout.write(binnum.pop()) # 无空格输出print ' (2)'</pre><div class="comt-meta wrapper"><span class="comt-author"><a target="_blank" href="javascript:;">(+__+)</a><div class="tooltip tooltip1"><p><i class="fa fa-user" aria-hidden="true"></i>&nbsp;&nbsp;&nbsp;(+__+)</p><p><i class="fa fa-envelope" aria-hidden="true"></i>&nbsp;&nbsp;lk0***21428@126.com</p></div></span>7年前 (2017-07-25)</div></div></li><!-- #comment-## -->
<li class="comment even thread-even depth-1" id="comment-17545"><span class="comt-f">#0</span><div class="comt-avatar wrapper"><i style="font-size:36px;" class="fa fa-user-circle" aria-hidden="true"></i><div class="tooltip"><p><i class="fa fa-user" aria-hidden="true"></i>&nbsp;&nbsp;&nbsp;九九乘法表</p><p><i class="fa fa-envelope" aria-hidden="true"></i>&nbsp;&nbsp;690***907@qq.com</p></div><div id="runoobvote-id-17545" data-commid = "17545" class="upvotejs"><a class="upvote"></a> <span class="count">22</span></div></div><div class="comt-main" id="div-comment-17545"><p>while循环 - 九九乘法表</p>
...
while i :
    ...
    i += 1
    if i &gt;= 10:
        break</pre><div class="comt-meta wrapper"><span class="comt-author"><a target="_blank" href="javascript:;">九九乘法表</a><div class="tooltip tooltip1"><p><i class="fa fa-user" aria-hidden="true"></i>&nbsp;&nbsp;&nbsp;九九乘法表</p><p><i class="fa fa-envelope" aria-hidden="true"></i>&nbsp;&nbsp;690***907@qq.com</p></div></span>7年前 (2017-09-14)</div></div></li><!-- #comment-## -->
<li class="comment odd alt thread-odd thread-alt depth-1" id="comment-25986"><span class="comt-f">#0</span><div class="comt-avatar wrapper"><i style="font-size:36px;" class="fa fa-user-circle" aria-hidden="true"></i><div class="tooltip"><p><i class="fa fa-user" aria-hidden="true"></i>&nbsp;&nbsp;&nbsp;流风回雪</p><p><i class="fa fa-envelope" aria-hidden="true"></i>&nbsp;&nbsp;145***2696@qq.com</p></div><div id="runoobvote-id-25986" data-commid = "25986" class="upvotejs"><a class="upvote"></a> <span class="count">41</span></div></div><div class="comt-main" id="div-comment-25986"><p>Pyhton 去除字符串首尾的空格：</p>
...
str = '   Runoob     '
print(trim(str))</pre><div class="comt-meta wrapper"><span class="comt-author"><a target="_blank" href="javascript:;">流风回雪</a><div class="tooltip tooltip1"><p><i class="fa fa-user" aria-hidden="true"></i>&nbsp;&nbsp;&nbsp;流风回雪</p><p><i class="fa fa-envelope" aria-hidden="true"></i>&nbsp;&nbsp;145***2696@qq.com</p></div></span>7年前 (2018-04-07)</div></div></li><!-- #comment-## -->
	</ol>
	<div class="pagenav">
			</div>
</div>
	...
	<form action="/wp-content/themes/runoob/option/addnote.php" method="post" id="commentform" style="display:none;">
		<div class="comt">
			...
			<div id="mded"></div>
				...
				<div class="comt-ctrl">
					<div class="comt-tips"><input type='hidden' name='comment_post_ID' value='4019' id='comment_post_ID' />
...
$(function() {
	...
	*/
	...
	if($('#comments').length && $('.upvotejs').length){
		$('.upvotejs').upvote({id: 4019, callback: callback});
	
		$.post(ajaxurl,{"action":"pinglun_zan","postid":4019},function(data){  
     ...
     <dl>
      <dt>
       最新更新
                   ...
                   <dd>
       &middot;
      <a href="http://www.runoob.com/cplusplus/cpp-data-structures.html" title="C++ 数据结构">C++ 数据结构</a>
      </dd>
              <dd>
       &middot;
      <a href="http://www.runoob.com/python3/python-selenium.html" title="Python selenium 库">Python selenium 库</a>
      </dd>
              <dd>
       &middot;
      <a href="http://www.runoob.com/cmake/cmake-exercises.html" title="CMake 实战练习">CMake 实战练习</a>
      </dd>
              <dd>
       &middot;
      <a href="http://www.runoob.com/cmake/cmake-advanced-features.html" title="CMake 高级特性">CMake 高级特性</a>
      </dd>
              <dd>
       &middot;
      <a href="http://www.runoob.com/cmake/cmake-build-demo.html" title="CMake 构建实例">CMake 构建实例</a>
      </dd>
              <dd>
       &middot;
      <a href="http://www.runoob.com/cmake/cmake-build-flow.html" title="CMake 构建流程">CMake 构建流程</a>
      </dd>
              <dd>
       &middot;
